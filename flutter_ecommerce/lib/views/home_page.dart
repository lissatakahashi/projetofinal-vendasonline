            ...
            children: [
              ...
              SizedBox(
                ...
                child: ListView(
                  ...
                  shrinkWrap: true,
                  children: const [
                    ChipWidget(chipLabel: 'Sala de estar'),
                    ChipWidget(chipLabel: 'Cozinha'),
                    ChipWidget(chipLabel: 'Banheiro'),
                    ChipWidget(chipLabel: 'Quarto'),
                    ChipWidget(chipLabel: 'Lavanderia'),
                    ChipWidget(chipLabel: 'Escritório'),
                  ],
                ),
              ),
              // Hot sales section
              ...
              const Row(
                ...
                children: [
                  Text('Mais Vendidos', style: AppTheme.kHeadingOne),
                  Text(
                    'Ver tudo',
              ...
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: const [
                  Text('Produtos em Destaque', style: AppTheme.kHeadingOne),
                  Text(
                    'Ver Tudo',
                    style: AppTheme.kSeeAllText,
                  ),
